...
os.system("title SpaceShip Doxing Tool - By DarkVador33")
os.system("color 1")
...
def ulookup():
     ...
     print()
     os.system("color 1")
     input("[!] Ended! Press any key to return to the menu!")
...
def doxcreator():
     doxname = input("[?] Dox name (it will create the dox in fr): ")
     name = input ("[?] Name: ")
     lastname = input("[?] LastName: ")
     age = input("[?] Age: ")
     address = input("[?] Address: ")
     supp = input("[?] More infos (exemple: Discord : Exemple#0000): ")
     fichier = open(doxname + ".txt", "a")
     fichier.write("**DOX CREATED WITH SPACESHIP, THE OFFICIAL 0sint FR DOXING TOOL**")
     fichier.write("")
     fichier.write("dsc.gg/0sintfr")
     fichier.write("")
     fichier.write("---------------------------------------------------")
